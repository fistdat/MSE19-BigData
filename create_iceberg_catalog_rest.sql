-- Create Iceberg Catalog with REST API (Nessie REST endpoint)
-- Following Dremio CDC best practices - Updated approach
-- =========================================================

-- 1. Create Iceberg Catalog với REST API to Nessie
