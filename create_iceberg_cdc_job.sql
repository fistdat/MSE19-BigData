-- =============================================================================
-- FLINK CDC TO ICEBERG LAKEHOUSE JOB
-- =============================================================================
-- This job streams CDC events from Kafka to Iceberg tables using REST catalog
-- =============================================================================
...
-- Configure Iceberg catalog using REST (compatible with Nessie)
...
-- Create Kafka CDC source table (same as before)
...
CREATE TABLE IF NOT EXISTS demographics_cdc (
    operation STRING,
    record_id STRING,
    city STRING,
    state STRING,
...
-- Insert CDC data into Iceberg table
INSERT INTO demographics_cdc
SELECT 
    CASE 
