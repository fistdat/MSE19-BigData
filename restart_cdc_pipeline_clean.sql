...
DROP TABLE IF EXISTS demographics_lakehouse_simple;
...
CREATE TABLE kafka_cdc_source (
    ...
    'properties.group.id' = 'flink-cdc-clean-consumer',
...
-- Create Iceberg sink table (APPEND ONLY)
CREATE TABLE demographics_lakehouse_realtime (
    operation STRING,
    record_id STRING,
    city STRING,
    state STRING,
...
-- Start streaming job
INSERT INTO demographics_lakehouse_realtime
SELECT 
    CASE 
