-- Working CDC to Lakehouse with Data Files Creation
-- Based on successful examples from Decodable and community repositories
-- This will create actual data files in MinIO, not just metadata
...
-- =====================================================
-- STEP 2: Create Nessie Catalog (Working Configuration)
-- =====================================================
...
-- This is the KEY pattern that creates data files!
-- =====================================================
...
WHERE `op` IN ('c', 'u', 'r'); -- Only capture inserts, updates, and reads 